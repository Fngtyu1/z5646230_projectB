...
- [x] Folder is named z5646230_projectB.
...
- [x] streamlit_app.py runs locally and the automated AppTest has zero exceptions.
...
- [x] AGENTS.md is project-specific and records the working contract.
- [x] ai/ contains prompt logs, critical corrections and AI notes.
